    ...
    <div class="w-full bg-white p-10">
      <div class="md:flex items-center border-b pb-6 border-gray-200">
        <div class="flex items-center md:mt-0 mt-4">
          ...
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">Sign Up</p>
        </div>
        <div class="flex items-center md:mt-0 mt-4 md:ml-12">
          ...
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">Security Check</p>
        </div>
        <div class="flex items-center md:mt-0 mt-4 md:ml-12">
          <div class="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
            <p class="text-base font-medium leading-none text-gray-800">03</p>
          </div>
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">Confirm Info</p>
        </div>
        <div class="flex items-center md:mt-0 mt-4 md:ml-12">
          <div class="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
            <p class="text-base font-medium leading-none text-gray-800">04</p>
          </div>
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">Onboarding</p>
        </div>
      </div>
      <h1
        tabindex="0"
