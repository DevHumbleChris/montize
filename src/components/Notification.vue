<template>
  <body style="min-height: 900px" class="flex items-center justify-center bg-gray-300">
    <div class="py-8">
      <button
    ...
    <div
      class="w-full h-full bg-gray-800 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0"
      id="chec-div"
      ref="chec"
    >
      <div
