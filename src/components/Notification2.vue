...
<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-10" @close="openNotification">
                    ...
                    <div class="mt-8">
                      ...
                      <div class="w-full p-3 mt-4 bg-red-100 rounded flex items-center">
                        ...
                        <div class="pl-3 w-full flex items-center justify-between">
                          <p tabindex="0" class="focus:outline-none text-sm leading-none text-red-700">
                      ...
                      <div class="w-full p-3 mt-8 bg-green-100 rounded flex items-center">
                        ...
                        <div class="pl-3 w-full">
                          <div class="flex items-center justify-between">
                            <p tabindex="0" class="focus:outline-none text-sm leading-none text-green-700">
