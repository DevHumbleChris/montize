  ...
  ">
    <div>
      <div class="relative -mx-6 px-6 py-4">
        <div>
          <img src="https://tailus.io/sources/blocks/navigation-layout/preview/images/logo.svg" class="w-32"
            alt="tailus logo" />
          <button :class="sideMenu ? 'float-right absolute right-4 top-5' : 'hidden'" @click="openSideMenu">
      ...
      <div class="mt-8 text-center">
        <img src="https://tailus.io/sources/blocks/navigation-layout/preview/images/second_user.webp" alt=""
      ...
      <ul class="space-y-2 tracking-wide mt-8">
        ...
        <li @click="openSideMenu">
          <div class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
            ...
            <router-link to="/categories" class="group-hover:text-gray-700">Categories</router-link>
          </div>
        </li>
        <li @click="openSideMenu">
          <div class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
            ...
            <router-link to="/expenses" class="group-hover:text-gray-700">Expenses</router-link>
          </div>
        </li>
        <li @click="openSideMenu">
          <div href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path class="fill-current text-gray-600 group-hover:text-cyan-600" fill-rule="evenodd"
            ...
            <router-link to="/profile" class="group-hover:text-gray-700">Profile</router-link>
          </div>
        </li>
        <li @click="openSideMenu">
          <div class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
            ...
            <router-link to="/reports" class="group-hover:text-gray-700">Reports</router-link>
          </div>
        </li>
        <li @click="openSideMenu">
    ...
    <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
      <button class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group" @click="openSideMenu">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
        </svg>
        <router-link to="/login" class="group-hover:text-gray-700">Logout</router-link>
      </button>
    </div>
  </aside>
</template>
