...
<template>
  <aside
    :class="
      sideMenu
        ? 'fixed z-20 top-0 pb-3 px-6 max-w-4xl flex flex-col justify-between h-screen border-r bg-white transition duration-300'
        : 'ml-[-100%] fixed z-20 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]'
    "
  >
    <div>
      ...
      <div class="mt-8 text-center">
        ...
        />
        <h5
          class="mt-4 text-sm lg:text-xl lg:text-xl font-semibold text-gray-600 lg:block"
        >
          Cynthia J. Watts
        </h5>
      </div>
